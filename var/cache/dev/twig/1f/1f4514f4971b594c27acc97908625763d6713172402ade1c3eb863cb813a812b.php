...
class __TwigTemplate_531f5b344c3daa9e272e32853b1f55cba3ba118d221d03a0e6bd2d60dcf370de extends Template
{
    private $source;
    private $macros = [];
    ...
    <p>Un email vous a été envoyé. Le lien expirera dans ";
        // line 7
        ...
        echo " heure.</p>
    <p>Si vous n'avez pas reçu le mail vérifiez vos spams où <a href=\"";
        // line 8
...
{% block body %}
<div class=\"container\">
    <p>Un email vous a été envoyé. Le lien expirera dans {{ tokenLifetime|date('g') }} heure.</p>
    <p>Si vous n'avez pas reçu le mail vérifiez vos spams où <a href=\"{{ path('app_forgot_password_request') }}\">essayez encore</a>.</p>
</div>
{% endblock %}
", "reset_password/check_email.html.twig", "/Users/danielgrondin/analyse/templates/reset_password/check_email.html.twig");
    }
}
