...
class __TwigTemplate_7975394c2b0bd26ff12c7ba929509f287a61ba4ec717bb1a97c4bb1c99cf0434 extends Template
{
    private $source;
    private $macros = [];
    ...
    <!-- Page Content -->
    <div class=\"container\">
        <h2 style=\"text-align: center; margin-top: -150px;\">Bienvenue sur Todo List, l'application vous permettant de gérer l'ensemble de vos tâches sans effort !</h2>
        <div class=\"row\">
            <div class=\"col-md-12\">
                ";
        // line 12
    ...
    <footer style=\"position: fixed; bottom: -20px;width: 100%; height: 50px; text-align: center;\">
        <div class=\"row\">
            <div class=\"col-lg-12\">
...
";
    ...
    public function block_header_img($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/todolist_homepage.png"), "html", null, true);
        echo "\" alt=\"todo list\" >";
    ...
    {
        return array (  182 => 25,  164 => 24,  141 => 26,  138 => 25,  136 => 24,  133 => 23,  124 => 20,  121 => 19,  117 => 18,  114 => 17,  105 => 14,  102 => 13,  98 => 12,  90 => 6,  80 => 5,  61 => 3,  38 => 1,);
    }
    ...
    <div class=\"container\">
        ...
        <div class=\"row\">
            <div class=\"col-md-12\">
                ...
                {% block header_img %}<img class=\"slide-image\" src=\"{{ asset('img/todolist_homepage.png') }}\" alt=\"todo list\" >{% endblock %}
            </div>
        </div>
    </div>
    <footer style=\"position: fixed; bottom: -20px;width: 100%; height: 50px; text-align: center;\">
...
{% endblock %}
", "default/index.html.twig", "/Users/danielgrondin/analyse/templates/default/index.html.twig");
    }
}
